...
export const HUMAN_EVALUATION_DATASET: HumanRhymePair[] = [
  ...
  { id: 'perf-20', query: 'वफ़ा', candidate: 'सज़ा', expectedTier: 'near', minScore: 0.70, description: '2-syllable open vowel cadence [-ə.aː]' },
  { id: 'perf-21', query: 'वफ़ा', candidate: 'ख़ुदा', expectedTier: 'near', minScore: 0.70, description: 'Equisyllabic 2-syllable open vowel coda [-aː]' },
  { id: 'perf-22', query: 'वफ़ा', candidate: 'अदा', expectedTier: 'near', minScore: 0.70, description: '2-syllable open vowel cadence [-ə.aː]' },
  { id: 'perf-23', query: 'फ़ना', candidate: 'बक़ा', expectedTier: 'near', minScore: 0.70, description: '2-syllable open vowel cadence [-ə.aː]' },
  ...
  { id: 'perf-26', query: 'सफ़र', candidate: 'असर', expectedTier: 'perfect', minScore: 0.95, description: '2-syllable schwa liquid cadence [-ə.sər]' },
  { id: 'perf-27', query: 'सफ़र', candidate: 'ख़बर', expectedTier: 'perfect', minScore: 0.95, description: '2-syllable schwa liquid cadence [-ə.bər]' },
  { id: 'perf-28', query: 'सफ़र', candidate: 'नज़र', expectedTier: 'perfect', minScore: 0.95, description: '2-syllable schwa liquid cadence [-ə.zər]' },
  { id: 'perf-29', query: 'मंज़िल', candidate: 'साहिल', expectedTier: 'perfect', minScore: 0.95, description: 'Two syllable [ɪl] rhyme' },
  { id: 'perf-30', query: 'मंज़िल', candidate: 'महफ़िल', expectedTier: 'near', minScore: 0.70, description: 'Two syllable [ɪl] rhyme' },
  ...
  { id: 'multi-09', query: 'ज़िंदगी', candidate: 'सादगी', expectedTier: 'strong', minScore: 0.88, description: 'Cross-length 3-to-2 syllable [-ɡiː] cadence match' },
  { id: 'multi-10', query: 'ज़िंदगी', candidate: 'ताज़गी', expectedTier: 'strong', minScore: 0.88, description: 'Cross-length 3-to-2 syllable [-ɡiː] cadence match' },
  { id: 'multi-11', query: 'बंदगी', candidate: 'सादगी', expectedTier: 'strong', minScore: 0.88, description: 'Cross-length 3-to-2 syllable [-ɡiː] cadence match' },
  { id: 'multi-12', query: 'बंदगी', candidate: 'ताज़गी', expectedTier: 'strong', minScore: 0.88, description: 'Cross-length 3-to-2 syllable [-ɡiː] cadence match' },
  ...
  { id: 'multi-20', query: 'सुकून', candidate: 'जुनून', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable [uːn] match' },
  { id: 'multi-21', query: 'हौसला', candidate: 'फ़ैसला', expectedTier: 'multisyllabic', minScore: 0.95, description: 'Multi-syllable 2-syllable [-sə.laː] match' },
  ...
  { id: 'multi-25', query: 'हालात', candidate: 'मुलाक़ात', expectedTier: 'strong', minScore: 0.90, description: 'Cross-length 2-to-3 syllable [-aːt̪] match' },
  ...
  { id: 'str-10', query: 'जज़्बात', candidate: 'हालात', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-aːt̪]' },
  { id: 'str-11', query: 'हालात', candidate: 'बरसात', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-aːt̪]' },
  ...
  { id: 'str-14', query: 'सुकून', candidate: 'कानून', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-uːn]' },
  { id: 'str-15', query: 'फ़ुरसत', candidate: 'क़ुदरत', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-ət̪]' },
  { id: 'str-16', query: 'फ़ुरसत', candidate: 'कसरत', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-ət̪]' },
  { id: 'str-17', query: 'फ़ुरसत', candidate: 'हसरत', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-ət̪]' },
  { id: 'str-18', query: 'फ़ुरसत', candidate: 'नफ़रत', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-ət̪]' },
  { id: 'str-19', query: 'फ़ुरसत', candidate: 'हरकत', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-ət̪]' },
  { id: 'str-20', query: 'क़ुदरत', candidate: 'कसरत', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-ət̪]' },
  { id: 'str-21', query: 'क़ुदरत', candidate: 'हसरत', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable monorhyme [-ət̪]' },
  { id: 'str-22', query: 'मुक़द्दर', candidate: 'सिकंदर', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 3-syllable monorhyme [-d̪ər]' },
  { id: 'str-23', query: 'मुक़द्दर', candidate: 'समंदर', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 3-syllable monorhyme [-d̪ər]' },
  { id: 'str-24', query: 'मुक़द्दर', candidate: 'कलंदर', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 3-syllable monorhyme [-d̪ər]' },
  { id: 'str-25', query: 'शानदार', candidate: 'ग़द्दार', expectedTier: 'perfect', minScore: 0.95, description: 'Equisyllabic 2-syllable [-daːr] monorhyme' },
  ...
  { id: 'near-12', query: 'जाम', candidate: 'बयान', expectedTier: 'near', minScore: 0.55, description: 'Bilabial to dental nasal [m ↔ n]' },
  ...
  { id: 'cons-04', query: 'वक़्त', candidate: 'मुक्त', expectedTier: 'consonance', minScore: 0.50, description: 'Consonance with shared [kt̪/qt̪] cluster, differing vowel' },
  ...
  { id: 'ass-03', query: 'बात', candidate: 'नाश', expectedTier: 'assonance', minScore: 0.45, description: 'Assonance with shared [aː] vowel, distinct coda' },
